...
<head>
    ...
    <title>Sign Up</title>
    <link rel="stylesheet" href="/WEB-INF/template/registration_style.css" >
        ...
        <form class="signUp" id="signUp" method="post">
            <fieldset>
                ...
                <div class="inputs">
                    ...
                    <div class="redirect-login col-12 align-self-start">Уже зарегестрированы? <div><a href="authorizationPage.html">Войти</a></div></div>
                </div>
            </fieldset>
        </form>
    </div>
